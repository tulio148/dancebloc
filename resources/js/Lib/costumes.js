export const Costumes = [
    {
        ...
        additionalInformation:
            "Costume can be adjusted to size using safety pins",
        images: {
            cover: "_DSC3453.webp",
            others: [
                "_DSC3453.webp",
    ...
    },
    {
        ...
        material: "Fabric, Feathers, Rhinestones, Sequins, Beads.",
        additionalInformation:
            "Costume can be adjusted to size using safety pin. This costume does not come with a matching headpiece, however we are happy to pair a separate headpiece for an additional fee.",
        images: {
            cover: "_DSC3357.webp",
            others: [
                "_DSC3354.webp",
    ...
    },
    {
        ...
        material: "Fabric, Feathers, Rhinestones, Sequins, Beads.",
        additionalInformation:
            "Costume can be adjusted to size using safety pin.",
        images: {
            cover: "_DSC3402.webp",
            others: [
                "_DSC3393.webp",
