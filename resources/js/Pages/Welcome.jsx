...
from complete beginners to seasoned dancers."
            ...
            >
                <h1 className="max-w-md tracking-widest text-7xl text-white font-thin text-right py-5 my-16 ">
                    Dance Bloc Brazil
                </h1>
            </Transition>
            <Transition
            ...
            >
                <div className="bg-[url('/homepagebackground.png')] w-full h-[500px] bg-cover"></div>
            </Transition>
            <div ref={ref}>
                <Transition
                    show={inView}
