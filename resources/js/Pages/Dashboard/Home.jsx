...
export default function Home({ user, enrolled_classes }) {
        ...
        <div className="sm:pt-28 px-5 w-full max-w-5xl flex flex-col items-center">
            ...
            <div className="w-full max-w-2xl">
                ...
                {enrolled_classes.length == 0 ? (
                    ...
                    <div className="w-full flex flex-wrap items-center gap-4 border-b bg-gradient-to-br from-white from-70% px-6 pt-6 pb-10 rounded-3xl shadow font-light text-2xl text-slate-500 tracking-wider">
