        ...
        <div className="sm:pt-28 px-5 w-full max-w-2xl flex flex-col items-center gap-10">
            ...
            {upcomingClasses.length != 0 ? (
                upcomingClasses.map((item) => (
                    <div
                        key={item.id}
                        className="flex flex-wrap items-center gap-4 p-4 sm:p-8 border-b bg-gradient-to-br from-white from-50% shadow rounded-xl font-light text-2xl text-slate-500"
                    >
